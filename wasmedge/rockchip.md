...
```
# Download
wget https://github.com/WasmEdge/WasmEdge/releases/download/0.11.2/WasmEdge-0.11.2-manylinux2014_aarch64.rpm
# install
dnf install WasmEdge-0.11.2-manylinux2014_aarch64.rpm
